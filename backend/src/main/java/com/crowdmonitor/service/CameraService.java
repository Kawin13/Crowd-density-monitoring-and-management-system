...
public class CameraService {
    ...
    public void deleteCamera(Long id) {
        ...
        try {
            ...
            // reports.camera_id has no ON DELETE CASCADE (by design — reports
            // are historical records and should outlive the camera). Surface
            // this as a clear 400 instead of letting the raw FK violation
            // fall through to a generic 500.
            throw new IllegalArgumentException(
                    "Cannot delete camera '" + cameraName + "': it still has generated reports referencing it.");
        }
