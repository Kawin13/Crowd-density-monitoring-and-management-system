...
public class MonitoringController {
    ...
    // Properly parameterized type for AI-service JSON responses. Using this with
    // RestTemplate#exchange (instead of postForEntity/getForEntity with the raw
    // Map.class token) avoids raw-type and unchecked-conversion warnings entirely,
    // so no @SuppressWarnings("unchecked") is needed anywhere in this class.
    private static final ParameterizedTypeReference<Map<String, Object>> AI_RESPONSE_TYPE =
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> analyzeStream(@PathVariable Long cameraId) {
        try {
            ...
            ResponseEntity<Map<String, Object>> aiResponse =
                    restTemplate.exchange(uri, HttpMethod.POST, null, AI_RESPONSE_TYPE);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> analyzeStreamStatus(@PathVariable Long cameraId) {
        ...
        try {
            ...
            ResponseEntity<Map<String, Object>> aiResponse =
                    restTemplate.exchange(uri, HttpMethod.GET, null, AI_RESPONSE_TYPE);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> uploadVideo(
        ...
        try {
            ...
            ResponseEntity<Map<String, Object>> aiResponse = restTemplate.exchange(
                    aiServiceUrl + "/api/analyze/video", HttpMethod.POST, requestEntity, AI_RESPONSE_TYPE);
